...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-surface text-content overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex items-center justify-between px-3 py-2 lg:hidden border-b border-border bg-surface-raised">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-content">PulseFeed</span>
          </div>
          <button
          ...
          <div className="max-w-3xl mx-auto p-4 md:p-5">
            ...
            {newItemCount > 0 && (
              <button
                ...
                className="w-full mb-4 py-2.5 px-4 rounded-lg bg-indigo-600/20 border border-indigo-500/40 text-indigo-300 text-sm font-medium hover:bg-indigo-600/30 transition-colors flex items-center justify-center gap-2"
              >
                <span>↑</span>
